...
/*                                                            */
/* Copyright (C) 2003-2007 by FANUC LTD. All rights reserved. */
/*                                                            */
/*------------------------------------------------------------*/
...
typedef struct odbshp {
    ...
    unsigned short  fig_ele[10] ;    /* figure element 1Å`6 */
...
typedef struct out_statinfo_dmg {
     short  dummy[1];     /* ñ¢égóp                       */
     short  dmg;          /* DMG NetserviceÉXÉeÅ[É^ÉXèÓïÒ */
     short  dummy1[7];    /* ñ¢égóp                       */
} OUT_STATINF_DMG ;
...
typedef struct dcsfmoni {
     long  data_cnt;		/* Axis Count */
     long  data_d[24] ;		/* Fixed Val  */
     long  data_p[24] ;		/* Present Val*/
} DCSFMONI;
...
FWLIBAPI short WINAPI cnc_get_mccteststs(unsigned short, short, short *, DCSMCA * );
